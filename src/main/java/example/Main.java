...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		ObjectName asc = new ObjectName("ServerManager:type=AccountServerController");
		ObjectName ascul = new ObjectName("Admin:type=AccountServerController.usersLimit");
		ObjectName rsc = new ObjectName("Admin:type=ResourceServerController");
		
		mbs.registerMBean(serverStatistics, asc);
		mbs.registerMBean(serverStatistics, ascul);
		mbs.registerMBean(resourceStatistics, rsc);
